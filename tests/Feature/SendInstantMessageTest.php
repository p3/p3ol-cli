...
it('can send an instant message', function () {
    ...
    expect($this->server->packet->toHex())->toBe('5a2a2a00427f7fa06953005600010001070400000011010a04000000010301084775657374333536011d00010a040000000203010c686f772061726520796f753f011d000002000d');
});
